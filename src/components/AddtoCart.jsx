...
const AddtoCart = () => {
  ...
  return (
    <div className="w-full p-4 sm:p-6 md:p-10 flex items-center justify-center mx-auto">
      <div className="w-full max-w-md max-h-screen flex flex-col rounded-lg bg-white shadow-xl border-l border-gray-200 overflow-hidden">
        ...
        {/* Cart Items — this is the part that scrolls */}
        ...
        {/* Bottom Section — stays pinned, never scrolls */}
